      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-xl font-bold bg-gradient-to-r from-violet-600 to-violet-700 bg-clip-text text-transparent">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              variant="ghost"
              size="icon"
              className="text-violet-600 hover:bg-violet-100 transition h-8 w-8"
              title="Logout"
            >
