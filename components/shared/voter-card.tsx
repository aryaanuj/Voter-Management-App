...
export function VoterCard({ voter }: VoterCardProps) {
  ...
  const [selectedSentiment, setSelectedSentiment] = useState<"favor" | "neutral" | "against" | null>(
    voter.sentiment || null,
  )
      ...
      <div className="bg-white rounded-xl p-4 border border-violet-100 hover:shadow-md transition-all duration-300">
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div className="relative flex-shrink-0">
            <img
              src={voter.image || "/placeholder.svg?height=56&width=56&query=voter profile"}
              alt={voter.name}
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-1 hover:bg-violet-100 rounded-full transition-colors flex-shrink-0"
                title="Edit"
              >
