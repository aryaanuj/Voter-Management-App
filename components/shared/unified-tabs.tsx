          ...
          <div className="flex items-end justify-around h-20">
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  {isActive && (
                    <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-gradient-to-br from-violet-600 to-violet-700 rounded-full flex items-center justify-center shadow-lg ring-3 ring-white">
                  ...
                  {/* Inactive Tab Icon */}
                  {!isActive && (
                    <Icon className="h-5 w-5 text-gray-400 group-hover:text-violet-600 transition-colors mb-0.5" />
                  )}
